...
public class gpxParser {
    ...
    public static Document readFile(InputStream inputFile) throws Exception { //exception is thrown if user gives invalid file name (caught in user.java)
    ...
    public static Object[] parse(InputStream inputFile) throws Exception { //exception is thrown if user gives invalid file name (caught in user.java)
        Document doc = readFile(inputFile);
